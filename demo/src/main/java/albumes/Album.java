...
public abstract class Album {
    ...
    /**
     * Revisa el album en las secciones que aun no esta completo y si se encuentran
     * completas cambia el estado del map paises completos a
     * True,y si ademas toda los paises estan completos cambia el estado de
     * AlbumCompleto a True;
     */
     ...
     * @param figu
     */
    public void agregarFigu(Figurita figu) {
        figuritasSinpegar.add(figu);
    }

    public void quitarFigu(Figurita figu) {
        figuritasSinpegar.remove(figu);
    }
    ...
    public ArrayList<String> verificarYpegarFigus() {// bueno aca use Iterator asi que no se pueden quejar
        ...
        if (this.AlbumCompleto == true) {// System.out.println("Album lleno, nada para agregar.");
            ...
            while (algo.hasNext()) {
                ...
                if (actual.getNumeroQueIdentifica() < coleccion.length
                    ...
                    coleccion[actual.getNumeroQueIdentifica()] = actual;// agrego al array, espero no me de problema de
                                                                        // ejecucion.
        ...
        // falta implementar la parte de verificar si el album esta completo y cambiar
        // el estado booleano de AlbumCOmpleto
    }
    ...
    /**
     * Busca en las figus sin pegar si hay alguna repetida y devuelve el codigo de
    ...
    public boolean contains(Figurita figu) {
        if (coleccion[figu.getNumeroQueIdentifica()] != null) {// si la posicion no es null, esta ocupada por una carta,
                                                               // que deberia ser la correcta.
            return true;
        }
    ...
    public ArrayList<Figurita> figusRepetidas() {
        ...
        for (Figurita iter : figuritasSinpegar) {
            if (estaRepetidaEnsinPegar(iter) || this.contains(iter)) {
                ...
                figuritasRep.add(clon);// por las dudas no vaya a ser que modifique el arrayList original, despues lo
                                       // veo.
            }
