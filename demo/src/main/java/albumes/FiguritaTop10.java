...
public class FiguritaTop10 extends Figurita {
    ...
    public FiguritaTop10(String nombre, String tipoDeFigu, String pais, int rankingValorBase, int numeroQueIdentifica,
            String sedeMundialYanio, String balonde) {
    ...
    public float ValorFinal() {// metodo polimorfico, la subclase lo va modificar.
        ...
        if (balonde.equals("plata"))
            ...
            throw new RuntimeException("Error, la figurita no es balon de plata ni de oro");
    ...
    protected Object clone() // throws CloneNotSupportedException
    {
        ...
        FiguritaTop10 nueva = new FiguritaTop10(this.nombre, this.tipoDeFigu, this.pais, this.rankingValorBase,
                this.numeroQueIdentifica, this.sedeMundialYanio, this.balonde);
        return nueva;
    }
